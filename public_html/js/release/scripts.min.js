                ...
                return this.getData().then(function(data) {
                    ...
                    if (data && data.products && data.products.length > 0) {
                        ...
                        for (var productIndex = 0; productIndex < totalProducts; productIndex++) {
                            ...
                            tableHtml += '<li class="c-accounts-table__row">' + "<ul>" + '<li class="accountTitle">' + '<span class="value">' + data.products[productIndex].accountTitle + "</span>" + "</li>" + '<li class="accountType">' + '<span class="legend">Interest rate: </span>' + '<span class="value">' + data.products[productIndex].interestRate + "%" + tableHasNoticeHtml + "</span>" + "</li>" + '<li class="interestRate">' + '<span class="legend">Minimum deposit: </span>' + '<span class="value">' + tableCurrencyHtml + data.products[productIndex].minimumDeposit + "</span>" + "</li>" + '<li class="minimumDeposit">' + '<span class="legend">Interest type: </span>' + '<span class="value">' + data.products[productIndex].interestType + "</span>" + "</li>" + "</ul>" + "</li>";
                        }
                    } else {
                        $(".c-loader").remove();
    ...
    $.fn.responsive_table_plugin = function(options) {
        ...
        return this.each(function() {
            ...
            if (totalWidth <= options.breakpoint && $(".tableNavigation").length < 1) {
                ...
                $navigation.html(responsiveTable.getNavigation($activeRowElement)).on("click touchstart", function(e) {
                    e.preventDefault();
